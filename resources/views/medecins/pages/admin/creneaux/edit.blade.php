    ...
    <div class="col-md-12">
        ...
        <div class="card-body">
             <form action="{{ route('medecin.creneaux.update',$creneaux) }}" method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label  class="col-md-2 col-form-label">Date debut</label>
                        <input required name="date_debut" class="form-control" type="date" value="{{ old('date_debut') ?? $creneaux->date_debut }}"/>
                        <label  class="col-md-2 col-form-label">Date fin</label>
                        <input required name="date_fin" class="form-control" type="date" value="{{ old('date_fin') ?? $creneaux->date_fin }}"/>
                        
                        <label  class="col-md-2 col-form-label">heur debut</label>
                        <input required name="heur_debut" class="form-control" type="time" value="{{ old('heur_debut') ?? $creneaux->heur_debut }}"/>
                        <label  class="col-md-2 col-form-label">heur fin</label>
                        <input required name="heur_fin" class="form-control" type="time" value="{{ old('heur_fin') ?? $creneaux->heur_fin }}"/>
                    </div>
                    <div class="col-md-6">
